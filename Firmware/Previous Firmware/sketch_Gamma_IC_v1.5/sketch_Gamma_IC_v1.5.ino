...
#define DIR               A2
#define STEP              A3
#define BTN_HEAD_UP       A4
#define BTN_HEAD_DOWN     A5
#define BTN_CLAW_OPEN     11
#define BTN_CLAW_CLOSE    12
#define SGN_CLAW_RELAY    13
#define SENS_MARINELLI_1   6
#define SENS_MARINELLI_2   7
#define SENS_MARINELLI_3   8
...
void setup() {
  pinMode(SENS_MARINELLI_1,INPUT_PULLUP);
  pinMode(SENS_MARINELLI_2,INPUT_PULLUP);
  pinMode(SENS_MARINELLI_3,INPUT_PULLUP);
  
  pinMode(BTN_HEAD_UP,INPUT);
  pinMode(BTN_HEAD_DOWN,INPUT);
  pinMode(SGN_CLAW_RELAY,OUTPUT);  
  digitalWrite(SGN_CLAW_RELAY,LOW);
